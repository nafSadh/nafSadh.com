...
<html>
	...
	<meta name="google-site-verification" content="xbuRNTGkdLHrkm1w367xiWE_yI6HJV3KZAl_BzQwiSY" />
		...
		<link href="<?php echo $pg->rpath;?>nafSadh.ico" rel="icon" type="image/x-icon" />
		<link href="<?php echo $pg->rpath;?>nafSadh.ico" rel="shortcut icon" type="image/x-icon" />
		...
		<link href="<?php echo $pg->rpath;?>css/iconFont.min.css" rel="stylesheet"/>
