...
function projectslist($projects, $rpath) {
  ...
  foreach ($projects as $pjct) {
    ...
    if ($pjct['org'] != null) {
      $str .= "<span class='proj-org fg-grayLight'><i class='icon-cube-2 fg-grayLight'></i> $pjct[org]</span>\n";
    }
    ...
    if (array_key_exists('getit', $pjct) && $pjct['getit'] != null) {
      $str .= "<i class='icon-download-2'></i> 	<a href='$pjct[getit]' 		class='fg-steel fg-hover-blue'>getit</a>\n";
    }
    if (array_key_exists('github', $pjct) && $pjct['github'] != null) {
      $str .= "<i class='icon-github-2'></i> 	<a href='$pjct[github]' 	class='fg-steel fg-hover-blue'>github</a>\n";
    }
    if (array_key_exists('sf', $pjct) && $pjct['sf'] != null) {
      $str .= "<i class='icon-beaker-alt'></i> 	<a href='$pjct[sf]' 		class='fg-steel fg-hover-blue'>sourceforge</a>\n";
    }
    if (array_key_exists('visit', $pjct) && $pjct['visit'] != null) {
      $str .= "<i class='icon-new-tab'></i> 	<a href='$pjct[visit]' 		class='fg-steel fg-hover-blue'>visit</a>\n";
    }
    if (array_key_exists('view', $pjct) && $pjct['view'] != null) {
      $str .= "<i class='icon-monitor-2'></i> 	<a href='$pjct[view]' 		class='fg-steel fg-hover-blue'>view</a>\n";
    }
    if (array_key_exists('pvt', $pjct) && $pjct['pvt'] != null) {
      $str .= "<i class='icon-locked'></i><span class='fg-steel fg-hover-blue'>$pjct[pvt]</span>\n";
    }
    if (array_key_exists('beta', $pjct) && $pjct['beta'] != null) {
      $str .= "<i class='icon-flag-2'></i><span class='fg-steel fg-hover-blue'>$pjct[beta]</span>\n";
    }
    $str .= "</span>
  </div>\n";
  }
...
$PROJLIST = array(
  ...
  array('name' => "TuneTour.me",
    ...
    'org' => "nafSadh",
    'tag' => "tune into music tours",
    'desc' => "your one-stop solution for touring with artist -- a web app made with JS and little bit of PHP",
    'github' => "https://github.com/nafSadh/TuneTour.me",
    'beta' => "new project",
    'visit' => "",
    'getit' => "",
    'since' => "2014",
  ...
  array('name' => "<small>SoC Verifi<sup>n</sup> & D/D devel</small>",
    'icon' => "img/soc.very.png",
    'url' => "",
    'org' => "Samsung",
  ...
  array('name' => "Bytex",
    ...
    'desc' => "a simple hex reader for files.<br/>Back than I started to get to know C# and this tool was first outcome.",
